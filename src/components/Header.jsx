      ...
      <div className=" container mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16 md:h-20">
          ...
          {["Home", "About", "Projects", "Experience", "Contact"].map(
            (item, index) => (
              <motion.a
                ...
                className="relative text-gray-800 dark:text-gray-200 hover:violet-600 dark:hover:text-violet-400 font-medium transition-colors duration-300"
                href="#"
              >
                {item}
        ...
        <div className=" md:flex hidden  items-center space-x-4">
          <motion.a
            ...
            href="https://github.com/heyayush87"
          >
          ...
          <motion.a
            ...
            transition={{ delay: 1.3, duration: 0.8 }}
            className="text-gray-700 dark:text-gray-300 hover:text-violet-600 dark:hover:text-violet-400 transition-colors duration-300"
            href="https://www.linkedin.com/in/ayush-kumar-131a2222a/"
          >
      ...
      <AnimatePresence>
        {contactFormOpen && (
          <motion.div
            ...
            exit={{ opacity: 0 }}
            transition={{ duration: 0.5 }}
            className="fixed insert-0 bg-black/50 background-blur-sm z-50 flex items-center justify-center p-4"
            ...
            >
              ...
              <form className="space-y-4">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.97 }}
                  className="w-full px-4 py-2 bg-gradient-to-r from-violet-600 to-violet-400 hover:from-violet-700 hover:to-purle-700 transition-all duration-300 rounded-lg shadow-md hover:shadow-lg hover:shadow-violet-600/50"
                >
                  Send Message
                </motion.button>
              </form>
